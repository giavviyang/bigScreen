...
var PDFViewerApplication = {
  ...
  open: function () {
    ...
    _regenerator["default"].mark(function _callee7(file, args) {
      ...
      //let searchParams = decodeURI(window.location.href);
      //console.log(searchParams)
      //let dataParams=searchParams.get("button")
      let dataParams=getQueryString("button")
      console.log("button:" + dataParams)
      if(dataParams || dataParams !== ''){
        if(dataParams.indexOf(0)!=-1){
          window.printFlag=true;
          document.getElementById('print').style.visibility='visible';
        }
        if(dataParams.indexOf(1)!=-1){
